...
FPSMeter = function(cls, root)                      //  function FPSMeter có 2 biến
{
    this.fpsArray = new Array();                    //  đặt array mảng fps
    this.fpsIndex = 0;                              //  đặt index bằng 0
    this.fps = document.createElement("div");       //  tạo thẻ div.
    this.fps.setAttribute("class", cls);            //  chèn class cls
    root.appendChild(this.fps);                     //  chen childs
    this.fpst = new Array();                        //
    for (var i = 0; i < 3; ++i)
    {
